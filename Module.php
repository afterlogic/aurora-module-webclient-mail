...
class Module extends \Aurora\System\Module\AbstractWebclientModule
{
	...
	public function GetSettings()
	{
		...
		$aSettings = array(
			...
			'DefaultFontName' => $this->getConfig('DefaultFontName'),
			'FontSizes' => $this->getConfig('FontSizes'),
			'DefaultFontSize' => $this->getConfig('DefaultFontSize'),
			...
			'AllowSourceCodeButton' => $this->getConfig('AllowSourceCodeButton', false),
